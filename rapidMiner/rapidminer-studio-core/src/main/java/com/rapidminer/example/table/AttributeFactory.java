...
import io.transwarp.midas.constant.rapidminer.TypeMap;
...
public class AttributeFactory {
	...
	public static String mapAttributeName(String name) {
		return (String)TypeMap.map().get(name);
	}

	public static String reverseMapAttributeName(String name) {
		return (String)TypeMap.reverseMap().get(name);
	}
