...
import io.transwarp.midas.adaptor.IAttribute;
import io.transwarp.midas.adaptor.IExample;
 ...
 * @author Ingo Mierswa
 */
public class Example implements Serializable, Map<String, Object>, IExample {
	...
	public double getPredictionLabel() {
		return getPredictedLabel();
	}

	@Override
	public int getIValue(IAttribute id) {
		return (int)getValue((Attribute)id);
	}
