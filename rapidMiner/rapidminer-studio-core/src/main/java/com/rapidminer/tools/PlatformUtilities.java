	...
	private static void initializeReleaseVersion() {
		synchronized (INIT_VERSION_LOCK) {
			...
			if (currentVersion == null) {
				...
				if (currentVersion == null) {
					throw new IllegalStateException("Could not initialize RapidMiner from properties file");
				}
			}
		}
	}
...
//		String home = "/home/mk/idea-project/rapidMiner";
	...
	private static boolean searchInClassPath() {
		logInfo("Searching in Java classpath for RapidMiner jars...");
