...
public class ResourceIOObjectEntry extends ResourceDataEntry implements IOObjectEntry {
	...
	public Parameters getParameters() {
		...
		parameters.setParameter(TYPE_NAME, "resource");
		return parameters;
	}

	@Override
	public long countWithoutRead() {
		throw new UnsupportedOperationException("ResourceIOObjectEntry not support countWithoutRead");
	}
}
