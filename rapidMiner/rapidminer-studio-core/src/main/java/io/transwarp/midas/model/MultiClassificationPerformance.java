...
public class MultiClassificationPerformance
        extends com.rapidminer.operator.performance.MultiClassificationPerformance {
    private String name;
    private double value;
    private double std;
    public MultiClassificationPerformance(String name, double value, double std, double [][] confusion, String[] labels) {
        this.name = name;
        this.value = value;
        this.std = std;
