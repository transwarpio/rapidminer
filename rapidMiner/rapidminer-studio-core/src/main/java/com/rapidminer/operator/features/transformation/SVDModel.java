 ...
 * @see PCA
 */
public class SVDModel extends AbstractModel implements ComponentWeightsCreatable, ISVDModel {
	...
	public SVDModel(ExampleSet set, String[] names, double[] singularValues, double[][] vectors) {
		super(set);
		this.vMatrix = new Matrix(vectors);
