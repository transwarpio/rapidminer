 ...
 */
public class ParameterSet extends ResultObjectAdapter implements IParameterSet {
	...
	// for midas
	public ParameterSet(String[] operators, String[] parameters, String[] values) {
		for (int i = 0; i < operators.length; i++) {
			parameterValues.add(new ParameterValue(operators[i], parameters[i], values[i]));
		}
	}
