...
public class WriteModelPMMLOp extends BaseOp {
    ...
    public WriteModelPMMLOp(OperatorDescription description) {
        super(description);
        remote = true;
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        ParameterTypeBoolean overwrite = new ParameterTypeBoolean(
