...
import io.transwarp.midas.adaptor.model.neuralnet.IImprovedNeuralNetModel;
 ...
 * @author Ingo Mierswa
 */
public class ImprovedNeuralNetModel extends PredictionModel implements IImprovedNeuralNetModel{
	...
	public ImprovedNeuralNetModel(ExampleSet examples, InputNode[] inputs, InnerNode[] inners, OutputNode[] outputs) {
		this(examples);
		inputNodes = inputs;
		innerNodes = inners;
		outputNodes = outputs;
