...
public class MacroConstructionOperator extends Operator {
	...
	private static final OperatorVersion FAILING_AT_WRONG_EXPRESSIONS = new OperatorVersion(1, 0, 0);

	private static final OperatorVersion NUMBERFORMAT_WITHOUT_ZEROS = new OperatorVersion(1, 0, 0);
