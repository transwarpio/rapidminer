...
import com.rapidminer.core.user.ButtonManager;
import com.rapidminer.core.user.LoginButton;
import com.rapidminer.core.user.LogoutButton;
...
public class MainToolBar extends JPanel {
	...
	private Component createResourcesButton() {
		...
		if (SystemInfoUtilities.getOperatingSystem() != OperatingSystem.OSX || !OSXAdapter.isAdapted()) {
			...
			builder.add(new AboutAction(RapidMinerGUI.getMainFrame()));
		}
