...
public class ExcelExampleSource extends AbstractDataResultSetReader {
	...
	public static final OperatorVersion CHANGE_5_0_4 = new OperatorVersion(1, 0, 0);
	...
	public static final OperatorVersion CHANGE_6_2_0_OLD_XLSX_IMPORT = new OperatorVersion(1, 0, 0);
