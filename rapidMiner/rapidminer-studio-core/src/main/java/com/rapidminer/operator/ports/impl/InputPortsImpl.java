...
import io.transwarp.midas.adaptor.IInputPort;
...
public class InputPortsImpl extends AbstractPorts<InputPort> implements InputPorts {
	...
	@Override
	public List<IInputPort> getAllIPorts() {
		List<IInputPort> res = new ArrayList<IInputPort>();
		for(InputPort port: portList){
			res.add(port);
		}
