...
import io.transwarp.midas.adaptor.operator.IPerformanceCriterion;
import io.transwarp.midas.adaptor.operator.IPerformanceVector;
 ...
 */
public class PerformanceVector extends AverageVector implements IPerformanceVector {
	...
	@Override
	public void addICriterion(IPerformanceCriterion criterion) {
		addCriterion((PerformanceCriterion) criterion);
	}
