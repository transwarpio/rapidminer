...
import io.transwarp.midas.adaptor.IOperatorChain;
 ...
 */
public abstract class OperatorChain extends Operator implements IOperatorChain {
	...
	@Override
	public List<IExecutionUnit> getISubprocesses() {
		List<IExecutionUnit> res = new ArrayList<IExecutionUnit>();
		for(ExecutionUnit unit: subprocesses){
			res.add(unit);
		}
		return res;
