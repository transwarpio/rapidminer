 ...
 */
public class MidasRegexpAttributeFilter extends AbstractAttributeFilterCondition {

	public static final String PARAMETER_REGULAR_EXPRESSION = SelectAttrsParams.RegularExp();
	public static final String PARAMETER_ADD_EXCEPTION = SelectAttrsParams.UseExceptionExp();
	public static final String PARAMETER_EXCEPT_REGULAR_EXPRESSION = SelectAttrsParams.ExceptRegularExp();
