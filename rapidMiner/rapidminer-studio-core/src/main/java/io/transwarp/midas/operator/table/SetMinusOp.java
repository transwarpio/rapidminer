...
/**
 * Created by linchen on 16-10-11.
 */
public class SetMinusOp extends BaseOp {
    private final InputPort exampleSetInput = getInputPorts().createPort("example set input");
    private final InputPort subtrahendInput = getInputPorts().createPort("subtrahend input");
    ...
    public SetMinusOp(OperatorDescription description) {
        super(description);
    }
