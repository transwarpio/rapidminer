...
import io.transwarp.midas.adaptor.model.tree.ITree;
 ...
 */
public class Tree implements Serializable, ITree {
	...
	@Override
	public void addIChild(ITree child, ISplitCondition condition) {
		addChild((Tree)child, (SplitCondition)condition );
	}
