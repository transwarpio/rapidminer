...
public class Base {
    ...
    public static String encodeObject(Serializable serializableObject, int options) throws IOException {
        if(serializableObject == null) {
            ...
            try {
                ...
                b64os = new Base.OutputStream(baos, 1 | options);
                if((options & 2) != 0) {
    ...
    public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws IOException {
        if(source == null) {
            ...
            Base.OutputStream var27 = null;

            try {
                var25 = new ByteArrayOutputStream();
                var27 = new Base.OutputStream(var25, 1 | options);
    ...
    public static void encodeToFile(byte[] dataToEncode, String filename) throws IOException {
        if(dataToEncode == null) {
            ...
            try {
                bos = new Base.OutputStream(new FileOutputStream(filename), 1);
    ...
    public static void decodeToFile(String dataToDecode, String filename) throws IOException {
        ...
        try {
            bos = new Base.OutputStream(new FileOutputStream(filename), 0);
    ...
    public static byte[] decodeFromFile(String filename) throws IOException {
        ...
        try {
            ...
            if(e.length() > 2147483647L) {
                ...
                int numBytes1;
                for(bis = new Base.InputStream(new BufferedInputStream(new FileInputStream(e)), 0); (numBytes1 = bis.read(buffer1, length, 4096)) >= 0; length += numBytes1) {
                    ;
                }
    ...
    public static String encodeFromFile(String filename) throws IOException {
        ...
        try {
            ...
            int numBytes1;
            for(bis = new Base.InputStream(new BufferedInputStream(new FileInputStream(e)), 1); (numBytes1 = bis.read(buffer, length, 4096)) >= 0; length += numBytes1) {
                ;
            }
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public OutputStream(java.io.OutputStream out, int options) {
            ...
            this.decodabet = Base.getDecodabet(options);
        }
            ...
            if(this.suspendEncoding) {
                ...
                if(this.encode) {
                    ...
                    if(this.position >= this.bufferLength) {
                        this.out.write(Base.encode3to4(this.b4, this.buffer, this.bufferLength, this.options));
                        this.lineLength += 4;
                    ...
                    this.buffer[this.position++] = (byte)theByte;
                    if(this.position >= this.bufferLength) {
                        int len = Base.decode4to3(this.buffer, 0, this.b4, 0, this.options);
        ...
        public void flushBase64() throws IOException {
            if(this.position > 0) {
                ...
                this.out.write(Base.encode3to4(this.b4, this.buffer, this.position, this.options));
                this.position = 0;
            }
        ...
        public int read() throws IOException {
            if(this.position < 0) {
                ...
                if(this.encode) {
                    ...
                    Base.encode3to4(b, 0, i, this.buffer, 0, this.options);
                    this.position = 0;
                    this.numSigBytes = 4;
                } else {
                    b = new byte[4];
                    ...
                    this.numSigBytes = Base.decode4to3(b, 0, this.buffer, 0, this.options);
                    this.position = 0;
                }
            }
