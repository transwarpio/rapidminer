...
public class RegressionPerformanceOp extends AbstractPerformanceOp {
    public RegressionPerformanceOp(OperatorDescription description) {
        super(description);
    }

    @Override
    public String[] getChoices() {
        return PerfParams.RegressionOptions();
    }
}
